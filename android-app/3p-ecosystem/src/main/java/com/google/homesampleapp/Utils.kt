...
fun setDeviceTypeStrings(unspecified: String, light: String, outlet: String, unknown: String, matterdoor: String) {
  DeviceTypeStrings =
      mutableMapOf(
          ...
          Device.DeviceType.TYPE_MATTERDOOR to matterdoor,
      )
}
...
fun convertToAppDeviceType(matterDeviceType: Long): Device.DeviceType {
  Log.i("DeviceType", "Matter device type: " + matterDeviceType);
  return when (matterDeviceType) {
    ...
    0L -> Device.DeviceType.TYPE_MATTERDOOR // MatterDoor
...
fun modeDisplayString(mode: Long): String {
...
// Iteration
const val ITERATION = 20000L

// Iteration
const val SETUP_PIN_CODE = 20202021L

// Minimum time required to handle the multi-admin commissioning
// intent just received.
const val MIN_COMMISSIONING_WINDOW_EXPIRATION_SECONDS = 30
